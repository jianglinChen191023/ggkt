<template>
  <div>
    ...
    <van-goods-action>
      <van-goods-action-button v-if="liveStatus === 0" type="danger" text="直播未开始" @click="play"/>
      <van-goods-action-button v-if="liveStatus === 1" type="danger" text="直播中" @click="play"/>
      <van-goods-action-button v-if="liveStatus === 2" type="danger" text="直播已结束" @click="play"/>
    </van-goods-action>
